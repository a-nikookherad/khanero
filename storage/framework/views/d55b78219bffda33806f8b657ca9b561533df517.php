...
<?php $__env->startSection('content'); ?>
    <div class="row back-url">
        <div class="col-md-12">
            <a class="" href="<?php echo e(route('AdminDashboard')); ?>">صفحه اصلی</a><span class="now-url"> / موقعیت ساختمان</span>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form role="form" action="<?php echo e(route('StorePositionType')); ?>" method="post" enctype="multipart/form-data" id="FormCreatePositionType">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control primary" dir="rtl" id="InputTitlePositionType" placeholder="عنوان را وارد کنید" autofocus>
                                </div>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0"
                        ...
                        <?php $__currentLoopData = $positionTypeModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="1">
                                ...
                                <td>
                                    <label id="btnActivePositionType<?php echo e($key+1); ?>" onclick="ajaxActivePositionType('<?php echo e($value->id); ?>','<?php echo e($key+1); ?>');" class="<?php if($value->active == 1): ?> btn btn-default btn-block <?php else: ?> btn btn-default btn-block <?php endif; ?>">
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function ajaxEditName(id) {
            ...
            $.ajax({
                url:"<?php echo e(url('edit/position-type').'/'); ?>"+id,
                method:"get",
        ...
        function ajaxActivePositionType(id,idInput) {
            $.ajax({
                url:"<?php echo e(url('active/position-type').'/'); ?>"+id,
                method:"get",
            }).done(function(returnData){
                // console.log(returnData);
