                                ...
                                <?php $__currentLoopData = $integratedModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="1">
                                        ...
                                        <td>
                                            ...
                                            <img style="width: 60px;" src="<?php echo e(asset('Uploaded/Gallery/Integrated/File/'.$value->getGallery[0]->url)); ?>" />
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-default" onclick="ajaxHostIntegrated(<?php echo e($value->id); ?>)"><?php echo e(count($value->getHost)); ?></button>
                                        </td>
                                        <td>
                                            <a href="<?php echo e(route('EditIntegrated', ['id' => $value->id])); ?>" class="btn btn-default btn-block">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                        <td>
                                            <label id="btnActiveIntegrated<?php echo e($key+1); ?>" onclick="ajaxActiveIntegrated('<?php echo e($value->id); ?>','<?php echo e($key+1); ?>');" class="<?php if($value->active == 1): ?> btn btn-default btn-block <?php else: ?> btn btn-default btn-block <?php endif; ?>">
                                                <?php if($value->active == 1): ?> تایید <?php else: ?> در انتظار تایید <?php endif; ?>
                                            </label>
                                        </td>
                                        <td>
                                            <?php (
