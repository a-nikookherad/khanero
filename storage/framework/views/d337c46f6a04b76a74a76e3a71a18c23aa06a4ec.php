...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row box-login">
        <div class="col-sm-4 col-sm-offset-4">
            <form action="<?php echo e(route('ActivityUser')); ?>" method="post" role="form" class="login" id="FormLogin">
                <?php echo e(csrf_field()); ?>

                <div class="row text-center">
                    <div class="col-md-12">
                        <img src="<?php echo e(asset('frontend/images/logo.png')); ?>" style="width: 30%">
                    </div>
                </div>
                <div class="row">
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#BtnSendCode').click(function () {
            $('.timer-loading').html('<img src="<?php echo e(asset('backend/img/img_loading/orange_circles.gif')); ?>" />');
            $.ajaxSetup({
                headers: {
            ...
            $.ajax({
                url: '<?php echo e(route('SendCodeSms')); ?>',
                type: 'post',
