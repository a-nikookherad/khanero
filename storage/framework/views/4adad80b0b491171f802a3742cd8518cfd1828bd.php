...
<header class="navbar main-header">
    <a class="navbar-brand" href="<?php echo e(route('HomePage')); ?>" target="" style="">
        <img src="<?php echo e(asset('frontend/images/logo-rent-latin.png')); ?>" style="width: 75px;" />
    ...
    <ul class="nav navbar-nav navbar-left">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo e(auth()->user()->name); ?> <img class="img-circle" src="<?php if(!file_exists(asset('Uploaded/User/Profile').'/'. auth()->user()->avatar)): ?> <?php echo e(asset('Uploaded/User/Profile').'/'. auth()->user()->avatar); ?> <?php else: ?> <?php echo e(asset('backend/img/avatar.png')); ?> <?php endif; ?>" alt="avatar" /> <b class="caret"></b></a>
        ...
        <ul class="nav nav-tabs nav-justified sidetabs">
            <?php if(auth()->check()): ?>
                <h2 class="text-center">
                    ...
                    <a style="text-decoration: none; color: #666;" href="<?php if(auth()->user()->role_id == 1): ?><?php echo e(route('AdminDashboard')); ?><?php else: ?><?php echo e(route('UserDashboard')); ?><?php endif; ?>"><?php echo e(auth()->user()->first_name); ?></a>
                </h2>
                <h5 class="text-center">
                    اعتبار شما : <?php echo e(auth()->user()->credit); ?> تومان
                </h5>
                <h5 class="text-center">
                    کد معرف : <?php echo e(GenerateCodeIntroduction(auth()->user()->id)); ?>
