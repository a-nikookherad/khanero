...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <style>
        body {
            /*background-image: url('http://www.rentt.ir/backend/css/44.png');*/
        }
        ...
        .logo-footer {
            ...
            padding: 10px;
            border-radius: 10px;
            box-shadow: 0px 30px 10px -15px #171717;
        }
        .logo-latin {
            width: 100px;
            padding: 15px;
...
<div class="body-loading">
    <img src="https://www.rentt.ir/backend/img/img_loading/orange_circles.gif"/>
</div>
    ...
    <div class="container-section">
        <div class="row">
            <div class="col-sm-6 col-xs-5 r-section">
                <ul>
                    <li><a href="<?php echo e(route('HomePage')); ?>"><img src="<?php echo e(asset('frontend/images/logo-rent-latin.png')); ?>"
                                                             class="img-responsive logo-latin"></a></li>
                        ...
                        <?php else: ?>
                            <div class="btn-group">
                                <button type="button" class="login-item dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span>
	                                    <?php 
                                            if(auth()->user()->avatar != '' && auth()->user()->avatar != 'default-user.png') {
                                            ...
                                            if($avatar == 'default-user.png') {
                                                $av = 'Uploaded/User/'.$avatar;
                                            } else {
                                                $av = 'Uploaded/User/Profile/'.$avatar;
                                            }
                                         ?>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6 box-namad">
                        <img src="https://trustseal.enamad.ir/logo.aspx?id=121367&amp;p=hdEAiFP1ywaQkyrm" alt=""
                             onclick="window.open(&quot;https://trustseal.enamad.ir/Verify.aspx?id=121367&amp;p=hdEAiFP1ywaQkyrm&quot;, &quot;Popup&quot;,&quot;toolbar=no, location=no, statusbar=no, menubar=no, scrollbars=1, resizable=0, width=580, height=600, top=30&quot;)"
                             style="cursor:pointer;width: 100px;" id="hdEAiFP1ywaQkyrm">
                    </div>
                    <div class="col-md-3 col-xs-6 box-namad">
