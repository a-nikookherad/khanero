...
<?php $__env->startSection('title', TitlePage('نمایش قوانین')); ?>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row box-rules">
                        <div class="col-md-4">
                            <div class="row">
                                <img src="<?php echo e(asset('frontend/images/them/rentt-1.jpg')); ?>" class="img-responsive" alt="">
                            </div>
                            <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <img src="<?php echo e(asset('frontend/images/them/rentt-2.jpg')); ?>" class="img-responsive" alt="">
                            </div>
                            <div class="row">
                                <h5 class="text-center">
                        ...
                        <div class="col-md-4">
                            <div class="row">
                                <img src="<?php echo e(asset('frontend/images/them/rentt-3.jpg')); ?>" class="img-responsive" alt="">
                            </div>
                            <div class="row">
                                <h5 class="text-center">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4">
                            <form action="<?php echo e(route('ConfirmRules')); ?>" method="post">
