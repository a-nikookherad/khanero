        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <div class="box-information show-information">
                    <p>
                        <span class="title-information">تعداد میهمان</span> : در این قسمت ظرفیت استاندارد اقامتگاه خود را وارد کنید(بر اساس فضا ، امکانات خواب).<br />
                        <span class="title-information">میهمان اضافه</span> : تعداد نفرات اضافه بر ظرفیت استاندارد اقامتگاه .<br />
                    ...
                    <div class="col-md-4 boxRooms">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <label class="BtnAddSub BtnAdd btn-calculate-total" data-type="add" id="">+</label>

                                    <input type="text" value="1" name="standard_guest" id="InputStandardGuest" class="input-text totals-1" readonly />

                                    <label class="BtnAddSub BtnSub btn-calculate-total" data-type="sub" id="">-</label>
                                </div>
                            </div>
                        </div>
                        <br />
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="0" name="count_guest" id="InputCountGuest" class="input-text totals-2" readonly />
...
<script>
    ...
    //
    //     if(type == 'add') {
    //         var t = parseInt($('.totals-1').val()) + parseInt($('.totals-2').val()) + 1;
    //     } else {
    //         if($('.totals-1').val() == 0 && $('.totals-2').val() == 0) {
    //             $('.total-sum').text(0);
    //             return false;
    //         }
    //         if($('.totals-1').val() == 0 && $('.totals-2').val() != 0) {
    //             $('.total-sum').text($('.totals-2').val());
    //             return false;
    //         }
    //         if($('.totals-1').val() != 0 && $('.totals-2').val() == 0) {
    //             $('.total-sum').text($('.totals-1').val());
    //             return false;
    //         }
    //         var t = parseInt($('.totals-1').val()) + parseInt($('.totals-2').val()) - 1;
    //         $('.total-sum').text(t);
    ...
    $('#step4').click(function () {
        ...
        formData.append('count_guest', $('#InputCountGuest').val());
    ...
    $('.btn-calculate-total').click(function () {
        var val1 = parseInt($('#InputStandardGuest').val());
        var val2 = parseInt($('#InputCountGuest').val());
        $('.total-sum').text(val1 + val2);
    });
</script>
