                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="facebook" class="form-control" value="<?php echo e($contactModel->facebook); ?>" id="InputFaceBook" placeholder="FaceBook Link" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="google" class="form-control" value="<?php echo e($contactModel->google); ?>" id="InputGoogle" placeholder="Google+ Link" />
                                    <?php if($errors->has('google')): ?>
                                        <span style="color:red;"><?php echo e($errors->first('google')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
