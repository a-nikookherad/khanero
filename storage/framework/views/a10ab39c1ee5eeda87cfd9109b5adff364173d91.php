...
<section class="text-right position-relative mb-3 P-GalleryPc container-fluid p-0">
    <div class="buttn-option">
        ...
        <button class="each-btn-1" onclick="SetFavorite($(this),<?php echo e($hostModel->id); ?>)">
        ...
        <div class="col-sm-6 p-0">
            <div id="lightgallery" class="list-unstyled owl-carousel R-sl owl-theme">
                <?php $__currentLoopData = $hostModel->getGallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="item" data-responsive="<?php echo e(asset('Uploaded/Gallery/Img/'. $value->img)); ?>" data-src="<?php echo e(asset('Uploaded/Gallery/Img/'. $value->img)); ?>" data-sub-html="<p>Fading Light</p><p>Classic view from Rigwood Jetty on Coniston Water an old archive shot similar to an old post but a little later on.</p>">
                        <div class="slide over-hidden"><img class="mw-100 glryPc" src="<?php echo e(asset('Uploaded/Gallery/Img/'. $value->img)); ?>" alt="image"></div>
                    </div>
            ...
            <section class="text-right position-relative P-MainTitle mb-3">
                <div class="row intro-bx d-flex align-items-center border-bottom pb-3">
                    <div class="col-sm-9 p-0">
                        ...
                        <!--</ul>-->
                        <h1 class="col-12 p-0 d-inline-block mb-2 text-dark maintitle"><?php echo e($hostModel->name); ?></h1>
                        <div class="col-12 p-0 text-right">
                            <span class="px-1 font-weight-bold position-relative info1"><?php echo e($hostModel->getProvince->name); ?> ، <?php echo e($hostModel->getTownship->name); ?></span>
                        </div> 
                        <div class="col-12 p-0 text-right">
                            <span class="px-1 font-weight-bold position-relative info2">کد اقامتگاه:</span>
                            <span class="px-1 font-weight-bold position-relative info1 text-theme"><?php echo e($hostModel->id + 5000); ?></span>
                        </div>
                                               
                    </div>
                    <div class="col-sm-3 p-0 d-flex justify-content-flex-end">
                        <div class="text-center P-InfoHost">
                            <img class="mw-100 rounded-circle pic-host" src="<?php echo e(asset('Uploaded/User/Profile/'.$hostModel->getUser->avatar)); ?>" alt="image"/>
                            <h5 class="px-2 name-host"><i class="ml-1 fas fa-check-circle"></i> <?php echo e($hostModel->getUser->first_name. ' ' .$hostModel->getUser->last_name); ?></h5>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="row border-bottom py-3">
                    <ul class="col-sm-4 list-option">
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            ...
                            <p class="name-bx1"> <?php echo e($hostModel->getBuildingType->name); ?></p>
                        </li>
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            ...
                            <p class="name-bx1"><?php echo e($hostModel->count_room); ?> اتاق </p>
                        </li>
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            ...
                            <p class="name-bx1"><?php echo e($hostModel->meter); ?> متر زیر بنا</p>
                        </li>
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            ...
                            <p class="name-bx1"> ظرفیت <?php echo e($hostModel->standard_guest); ?> نفر </p>
                        </li>
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            ...
                            <p class="name-bx1"><?php echo e($hostModel->double_bed); ?> تخت دو نفره</p>
                        </li>
                        <li class="p-2 p-lg-3 text-center d-flex align-items-center">
                            <svg class="icon-svg" class="icon-svg"  width="16" height="16" viewBox="0 0 16 16" icon="tv" class="fxsh0 w16 h16 f-gray-extra-dark"><path d="M16 10.476c0 .73-.594 1.365-1.344 1.365h-4.531c0 .698.531 1.302.531 1.62a.531.531 0 0 1-.531.539h-4.25a.531.531 0 0 1-.531-.54c0-.317.531-.889.531-1.62H1.344C.594 11.84 0 11.207 0 10.477v-7.11C0 2.634.594 2 1.344 2h13.312c.75 0 1.343.635 1.343 1.365l.001 7.11zm-1.062-7.11c0-.128-.125-.287-.282-.287H1.344c-.156 0-.281.16-.281.286v7.047c0 .127.125.254.281.254h13.312c.157 0 .282-.127.282-.254V3.365z"></path></svg class="icon-svg" class="icon-svg" >
                            <p class="name-bx1">حداقل اقامت <?php echo e($hostModel->min_reserve_day); ?> شب</p>
                        </li>
                    </ul>
                    <div class="col-sm-8">
                        <div class="box-map">
                            ...
                            <script>
                                var tiles = L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
                                    ...
                                    latlng = L.latLng(<?php echo e($hostModel->latitude); ?>, <?php echo e($hostModel->longitude); ?>); // tehran
                                var map = L.map('map-markers', {center: latlng, zoom: 17, layers: [tiles]});
                                var title = 'عنوان مارکر';
                                var marker = L.marker(new L.LatLng(<?php echo e($hostModel->latitude); ?>, <?php echo e($hostModel->longitude); ?>), {title: title});
                ...
                <div class="Possibilities2 border-bottom py-3">
                    ...
                    <ul class="see-moreless row align-items-center">
                        ...
                        <?php $__currentLoopData = $hostModel->getHostPossibilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php  $arr_opt[] = $value->option_id  ?>
                            <li class="col-sm-3 px-0 py-2 align-items-center Bx4 ">
                                <img class="option-img" src="<?php echo e(asset('Uploaded/Possibilities/Option/'.$value->getOption->img)); ?>">
                                <p class="txt-09"><?php echo e($value->getOption->name); ?></p>
                                <?php if($value->description != ''): ?>
                                    <span tooltip="<?php echo e($value->description); ?> " class="more-info">?</span>
                                <?php endif; ?>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = GetOption(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!in_array($value->id, $arr_opt)): ?>
                                <li class="col-sm-3 px-0 py-2 align-items-center Bx4 is-Not">
                                    <img class="option-img" src="<?php echo e(asset('Uploaded/Possibilities/Option/'.$value->img)); ?>">
                                    <div class="titl-prt-01">
                                        <p class="txt-09"><?php echo e($value->name); ?></p>
                                    </div>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <section class="text-right position-relative P-Summary my-3">
                <div class="border-bottom py-3">
                    <div class="raterow">
                        ...
                        <p class="text-01">
                            <?php echo e($hostModel->description); ?>
                    ...
                    <div class="P-pazirayi">
                            <ul class="see-moreless1 row align-items-center">
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    ...
                                    <span class="data-pz"> <?php echo e($hostModel->floor); ?></span>
                                </li>
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    <span class="text-pz"> سال ساخت: </span>
                                    <span class="data-pz"><?php echo e($hostModel->year); ?></span>
                                </li>
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    <span class="text-pz">نوع اجاره: </span>
                                    <span class="data-pz">
                                        <?php if($hostModel->type_rent == 1): ?>
                                            مجزا
                                        <?php elseif($hostModel->type_rent == 2): ?>
                                            دربستی
                                        <?php elseif($hostModel->type_rent == 3): ?>
                                            اتاق خصوصی
                                        <?php endif; ?>
                                    </span>
                                </li>
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    ...
                                    <span class="data-pz">
                                        <?php if($hostModel->shape_host == 1): ?>
                                            مسطح
                                        <?php elseif($hostModel->shape_host == 2): ?>
                                            دوبلکس
                                        <?php elseif($hostModel->shape_host == 3): ?>
                                            تریبلکس
                                        <?php endif; ?>
                                    </span>
                                </li>
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    ...
                                    <span class="data-pz"> <?php echo e($hostModel->building_floor); ?> </span>
                                </li>
                                <li class="col-sm-4 px-0 py-2 align-items-center Bx4">
                                    <span class="text-pz">تعداد اتاق: </span>
                                    <span class="data-pz"> <?php echo e($hostModel->count_room); ?> </span>
                                </li>
                            </ul>
                        </div>
                </div>
                ...
                <div class="Rules-regulation border-bottom py-3">
                    ...
                    <div class="Arrivals-Departures py-3">
                        <li class="bx-entrexit d-flex align-items-center exist-1">
                            ...
                            <p>ساعت ورود</p>
                            <p class="clock"> از <?php echo e($hostModel->time_enter_from); ?> تا <?php echo e($hostModel->time_enter_to); ?></p>
                        </li>
                        <li class="bx-entrexit d-flex align-items-center">
                            <svg data-id="SVG_GUEST_CHECKED_IN_COLOR__24" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" stroke="none" fill="none" viewBox="0 0 24 24"><path stroke="#2474DE" d="M3.492 11.998h11.316M12.058 8.996l3.002 3.002L12.058 15"></path><path stroke="#292929" d="M8.745 7.424V5.782c0-.71.576-1.287 1.286-1.287h7.19c.71 0 1.286.576 1.286 1.287v12.436c0 .71-.576 1.287-1.286 1.287h-7.19c-.71 0-1.286-.576-1.286-1.287v-1.642"></path></svg>
                            <p>ساعت خروج</p>
                            <p class="clock"> تا <?php echo e($hostModel->time_exit); ?></p>
                        </li>                    
                    </div>
                    <ul class="Rules-items">
                        <?php 
                            ...
                            $arr_rule = [];
                         ?>
                        <?php $__currentLoopData = $hostModel->getHostRules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php  $arr_rule[] = $value->rule_id  ?>
                            <li><i class="fas fa-check"></i><?php echo e($value->getRules->name); ?></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = GetRule(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if(!in_array($value->id, $arr_rule)): ?>
                                <li><i class="fas fa-times"></i><?php echo e($value->name); ?></li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <hr />
                    ...
                    <div class="decription-about">
                        ...
                        <p>
                            <?php echo e($hostModel->other_position); ?>
                    ...
                    <ul class="off-items">
                        <?php if(count($hostModel->getDiscount) > 0): ?>
                            <?php $__currentLoopData = $hostModel->getDiscount; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><?php echo e($value->percent); ?> % تخفیف برای اقامت بیشتر از <?php echo e($value->number_days); ?> روز</li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class=" d-flex align-items-center">
                            <span class="night-price"> هر شب از :</span>
                            <span class="number-price"><?php echo e(number_format(GetMinPrice($hostModel->id))); ?></span>
                            <span class="unitq-price">تومان</span>                            
                        </div>
                    ...
                    <div class="detail-date-box">
                        ...
                        <div class="col-sm-12 extra-person">
                            <p>در صورت بیشتر بودن  از <span class="min-numb"> <?php echo e($hostModel->standard_guest); ?> </span> نفر , به ازای هر نفر <span class="price-extra"> <?php echo e(number_format($hostModel->one_person_price)); ?> </span>تومان اضافه میگردد .</p>
                        </div>
                    </div>
...
<script src="<?php echo e(asset('frontend/js/gallery.js')); ?>"></script>
    ...
    <script>
        ...
        function CalculateFactor(type) { // type => محاسبه یا ثبت رزرو
            ...
            if (type == 'calculate') {
                ...
                $('#PreFactor').html('<img style="width: 55px; margin: 0 auto;" src="<?php echo e(asset('backend/img/img_loading/loading-register.gif')); ?>" />');

            } else if (type == 'reserve') {

                $('.form-reserve').css('opacity', '0.6');
                $('.display-block').css('display', 'block');
                $('#SpanLoading').html('<img style="width: 80px; margin: 0 auto;" src="<?php echo e(asset('backend/img/img_loading/loading-register.gif')); ?>" />');
