                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 py-2 date-cal">
                        ...
                        <div class="bx-dTER d-flex">
                            <input class="each-01" placeholder="تاریخ ورود" id="InputDateFrom">
                            <input class="each-01" placeholder="تاریخ خروج" id="InputDateTo">
                        </div>                         
                    </div>
                    ...
                    <!--</div>-->
                    <div class="col-md-12">
                        <input type="button" id="BtnReserveHost" class="btn btn-block btn-reserve" value="درخوااست رزرو">
                    </div>
