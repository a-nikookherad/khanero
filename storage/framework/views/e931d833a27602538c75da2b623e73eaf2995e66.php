                    ...
                    <?php $__currentLoopData = $favoriteModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php endif; ?>
                                <div class="col-md-3 box-favorite">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <img src="<?php echo e(asset('Uploaded/Gallery/Img').'/'.$value->getHost->getGallery[0]->img); ?>" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5 class="text-primary">
                                                <a href="<?php echo e(route('DetailHost', ['id' => $value->host_id])); ?>" target="_blank"><?php echo e($value->getHost->name); ?></a>
                                            </h5>
                                        </div>
                                        <div class="col-md-6">
                                            <label data-toggle="modal" data-target="#myModal" onclick="ajaxDeleteFavorite('<?php echo e($value->id); ?>');" class="btn btn-default btn-block">
