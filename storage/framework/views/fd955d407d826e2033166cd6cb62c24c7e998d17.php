    ...
    <div class="panel-body row">
        <div class="col-md-8">
                        <?php $__currentLoopData = $rulesModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="each-item row">
                                <div class="col-md-7 each-option-1">
                                    ...
                                    <label class="title-S" for="slideThree_<?php echo e($key+1); ?>"><?php echo e($value->name); ?></label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="each-Qt form-control <?php if(!in_array($value->id, $arr)): ?> none <?php endif; ?>  description input<?php echo e($key+1); ?>" name="" id="" placeholder="<?php echo e($value->description); ?>" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="each-item col-md-12">
                                    ...
                                    <textarea class="each-Qt form-control textarea" rows="4" id="InputNewRules" placeholder="قوانین خود را وارد کنید"><?php echo e($hostModel->new_rule); ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="each-item col-md-3">
                                    ...
                                    <select id="SelectMinReserve" class="each-Qt form-control">
                                        <?php for($i = 1; $i<= 10; $i++): ?>
                                            <option value="<?php echo e($i); ?>"><?php echo e($i); ?> شب</option>
                                        <?php endfor; ?>
                                    </select>
                            </div>
                        </div>
        ...
        <div class="col-md-12 row btn-footer">
            <div class="col-md-6 text-right">
                <a href="<?php echo e(route('CreateHostStep', ['id' => $hostModel->id, 'step' => 3])); ?>" class="prv-btn btn btn-default btn-block"> <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i> مرحله قبلی </a>
            </div>
