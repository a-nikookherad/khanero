            ...
            <div class="panel border-green">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>قوانین لغو رزرو</label><span style="font-size: 18px;"
                                                                    class="text-danger">*</span>
                                <select name="cancel_rule_id" id="SelectCancelRule" class="form-control CancelRule">
                                    ...
                                    <?php $__currentLoopData = config('setting.CancelReserveRule'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($value['id']); ?>"
                                                <?php if($hostModel->cancel_rule_id == $value['id']): ?> selected <?php endif; ?>><?php echo e($value['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $__currentLoopData = config('setting.CancelReserveRule'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="description-rule<?php echo e($value['id']); ?> desc-rule"
                                         style="<?php if($hostModel->cancel_rule_id == $value['id']): ?> display: block; <?php else: ?> display: none; <?php endif; ?>">
