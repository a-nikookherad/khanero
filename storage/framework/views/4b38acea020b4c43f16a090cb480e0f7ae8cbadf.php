    ...
    <div class="panel-body row">
            ...
            <div class="row line-height-35">
                ...
                <div class="each-item col-md-6 rows row">
                    <div class="col-md-3 text-right each-option-1">
                        ...
                        <label class="title-S m-0" title="<?php echo e($value->description); ?>" for="slideThree<?php echo e($key+1); ?>"><?php echo e($value->name); ?></label>
                    </div>
                    <div class="col-md-9">
                        <input type="text" class="each-Qt form-control <?php if(!in_array($value->id, $arr)): ?> none <?php endif; ?> description input<?php echo e($key+1); ?>" name="" id="" placeholder="<?php echo e($value->description. ' ' . $value->name); ?>" />
                    </div>
                </div>
                <?php ($counter++); ?>
                ...
                <?php $__currentLoopData = $serviceModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="each-item col-md-6 rows row">
                        <div class="col-md-3 text-right each-option-1">
                            ...
                            <span class="checkmark"></span>
                            <label class="title-S m-0" title="<?php echo e($value->description); ?>" for="slideThree_<?php echo e($key+1); ?>"><?php echo e($value->name); ?></label>
                        </div>
                        <div class="col-md-9">
                            <input type="text" class="each-Qt form-control none description input<?php echo e($key+1); ?>" name="" id="" placeholder="<?php echo e($value->description); ?>" />
                        </div>
                    </div>
                    <?php ($counter++); ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-md-12 row btn-footer">
                    <div class="col-md-6 text-right">
                        <a href="<?php echo e(route('CreateHostStep', ['id' => $hostModel->id, 'step' => 1])); ?>" class="prv-btn btn btn-default btn-block"> <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i> مرحله قبلی </a>
                    </div>
