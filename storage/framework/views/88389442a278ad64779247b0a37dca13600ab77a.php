                ...
                <div class="row">
                    <div class="col-md-8">
                        <?php $__currentLoopData = $rulesModel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row rows">
                                <div class="col-md-1">
                                    <input type="checkbox" <?php if(in_array($value->id, $arr)): ?> checked <?php endif; ?> value="<?php echo e($value->id); ?>" class="chk check-description" data-value="<?php echo e($key+1); ?>" id="slideThree_<?php echo e($key+1); ?>" name="check<?php echo e($key+1); ?>" />
                                </div>
                                <div class="col-md-6">
                                    <label for="slideThree_<?php echo e($key+1); ?>"><?php echo e($value->name); ?></label>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" class="form-control <?php if(!in_array($value->id, $arr)): ?> none <?php endif; ?>  description input<?php echo e($key+1); ?>" name="" id="" placeholder="<?php echo e($value->description); ?>" />
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea" rows="4" id="InputNewRules" placeholder="قوانین خود را وارد کنید"><?php echo e($hostModel->new_rule); ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="SelectTimeEnterFrom" class="form-control">
                                        <?php for($i = 1; $i<= 24; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->time_enter_from): ?> selected <?php endif; ?>>
                                                <?php if($i > 0 && $i > 12): ?>
                                                    <?php echo e($i - 12); ?>
                                                ...
                                                <?php elseif($i == 12): ?>
                                                    ظهر
                                                <?php elseif($i > 12 && $i < 18): ?>
                                                    بعد از ظهر
                                                <?php elseif($i > 17 && $i < 21): ?>
                                                    عصر
                                                <?php else: ?>
                                                    شب
                                                <?php endif; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="SelectTimeEnterTo" class="form-control">
                                        ...
                                        <?php for($i = 1; $i<= 24; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->time_enter_to): ?> selected <?php endif; ?>>
                                                <?php if($i > 0 && $i > 12): ?>
                                                    <?php echo e($i - 12); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="SelectTimeExit" class="form-control">
                                        <?php for($i = 1; $i<= 24; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->time_exit): ?> selected <?php endif; ?>>
                                                <?php if($i > 0 && $i > 12): ?>
                                                    <?php echo e($i - 12); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select id="SelectMinReserve" class="form-control">
                                        <?php for($i = 1; $i<= 10; $i++): ?>
                                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->min_reserve_day): ?> selected <?php endif; ?>><?php echo e($i); ?> روز</option>
                                        <?php endfor; ?>
                                    </select>
                                </div>
                            </div>
