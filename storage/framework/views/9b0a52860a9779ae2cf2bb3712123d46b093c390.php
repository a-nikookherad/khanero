...
<?php $__env->startSection('title', TitlePage('ویرایش محتوا')); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="InputTypeContent">
                                        <option value="1" <?php if($contentModel->type == 1): ?> selected <?php endif; ?>>ارتباط با ما</option>
                                        <option value="2" <?php if($contentModel->type == 2): ?> selected <?php endif; ?>>دسترسی سریع</option>
                                    </select>
                                </div>
                            </div>
                        </div>
