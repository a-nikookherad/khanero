        ...
        <div class="col-md-8">
            <div class="row">
                ...
                <div class="each-item col-md-12">
                    ...
                    <input type="text" class="each-Qt form-control" value="<?php echo e($hostModel->name); ?>" name="" id="InputHostName" placeholder="نام اقامتگاه - برای مثال : ویلای ۴۰۰ متری دوبلکس دماوند"/>
                </div>
                <div class="each-item col-md-6">
                    <label class="title-S" for="InputMeter">متراژ اقامتگاه</label>
                    <input type="text" name="meter" value="<?php echo e($hostModel->meter); ?>" class="each-Qt form-control" id="InputMeter" placeholder="متراژ را وارد کنید"/>
                </div>
                <div class="each-item col-md-6 meter-total" style="<?php if($hostModel->building_type_id != 6 && $hostModel->building_type_id != 7): ?> display: none <?php endif; ?>">
                    <label class="title-S" for="InputMeterTotal">متراژ کل زمین</label>
                    <input type="text" name="meter_total" value="<?php echo e($hostModel->meter_total); ?>" class="each-Qt form-control" id="InputMeterTotal" placeholder="متراژ کل بنا را وارد کنید"/>
                </div>
                <div class="each-item col-md-6">
                    <label class="title-S" for="InputYear">سال ساخت</label>
                    <select class="each-Qt form-control" id="InputYear">
                        <?php for($i = 1400; $i >= 1360; $i--): ?>
                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->reconstruction): ?> selected <?php endif; ?>>
                                <?php echo e($i); ?>
                ...
                <div class="each-item col-md-6">
                    ...
                    <select class="each-Qt form-control" id="InputBuildingFloors">
                        <?php for($i = 1; $i <= 30; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php if($i == $hostModel->building_floor): ?> selected <?php endif; ?>>
                                <?php echo e($i); ?>
                ...
                <div class="each-item col-md-6 has-radio">
                    ...
                    <div class="each-Qt flex align-items-center oth-er">
                        <div class="position-relative">
                            <input type="radio" value="1" name="type_rent" <?php if($hostModel->type_rent == 1): ?> checked <?php elseif($hostModel->type_rent == null): ?> checked <?php endif; ?> id="InputTypeRent1"/>
                            <div class="check"></div>
                            <label for="InputTypeRent1"> واحد مجزا </label>
                        </div>
                        <div class="position-relative">
                            <input type="radio" value="2" name="type_rent" <?php if($hostModel->type_rent == 2): ?> checked <?php endif; ?> id="InputTypeRent2"/>
                            <div class="check"></div>
                            <label for="InputTypeRent2"> دربستی </label>
                        </div>
                        <div class="position-relative">
                            <input type="radio" value="3" name="type_rent" <?php if($hostModel->type_rent == 3): ?> checked <?php endif; ?> id="InputTypeRent3"/> 
                            <div class="check"></div>
                ...
                <div class="each-item col-md-6 has-radio">
                    ...
                    <div class="each-Qt flex align-items-center oth-er">
                        <div class="position-relative">
                            <input type="radio" value="1" name="register_by" <?php if($hostModel->register_by == 1): ?> checked <?php endif; ?> id="InputRegisterBy1"/>
                            <div class="check"></div>
                            <label for="InputRegisterBy1"> مالک </label>
                        </div>
                        <div class="position-relative">
                            <input type="radio" value="2" name="register_by" <?php if($hostModel->register_by == 2): ?> checked <?php endif; ?> id="InputRegisterBy2"/>
                            <div class="check"></div>
                ...
                <div class="each-item col-md-6 has-radio">
                    ...
                    <div class="each-Qt flex align-items-center oth-er">
                        <div class="position-relative">
                            <input type="radio" value="1" name="shape_host" <?php if($hostModel->shape_host == 1): ?> checked <?php elseif($hostModel->shape_host == null): ?> checked <?php endif; ?> id="InputShapeHost1"/> 
                            <div class="check"></div>
                            <label for="InputShapeHost1"> مسطح </label>
                        </div>
                        <div class="position-relative">
                            <input type="radio" value="2" name="shape_host" <?php if($hostModel->shape_host == 2): ?> checked <?php endif; ?> id="InputShapeHost2"/>
                            <div class="check"></div>
                            <label for="InputShapeHost2"> دوبلکس </label>
                        </div>
                        <div class="position-relative">
                            <input type="radio" value="3" name="shape_host" <?php if($hostModel->shape_host == 3): ?> checked <?php endif; ?> id="InputShapeHost3"/>
                            <div class="check"></div>
                ...
                <div class="each-item col-md-6">
                    ...
                    <div class="each-Qt number">
                        ...
                        <input type="text" value="<?php if($hostModel->standard_guest == ''): ?> 1 <?php else: ?> <?php echo e($hostModel->standard_guest); ?> <?php endif; ?>" class="input-text"
                ...
                <div class="each-item col-md-6">
                    ...
                    <div class="each-Qt number">
                        ...
                        <input type="text" value="<?php if($hostModel->count_guest == ''): ?> 1 <?php else: ?> <?php echo e($hostModel->count_guest); ?> <?php endif; ?>" class="input-text" id="InputMaximumCapacity" readonly>
                ...
                <div class="each-item col-md-6">
                    ...
                    <div class="each-Qt number">
                        ...
                        <input type="text" value="<?php echo e(count($hostModel->getRoom)); ?>" class="input-text" id="InputCountRoom" readonly placeholder="تعداد نفرات">
                    ...
                    <div class="boxRoom">
                        <?php $__currentLoopData = $hostModel->getRoom; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="each-item col-md-12 box">
                                <p class="some-title">اتاق شماره <?php echo e($key+1); ?></p>
                                <div class="boxs">
                                    <div class="each-item col-md-3">
                                        <label class="title-S">تخت یک نفره</label>
                                        <select class="each-Qt form-control" name="single_bed" id="InputSingleBed">
