        ...
        <ul class="sidemenu">
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    <li class="sidebar-dropdown-title"><p>میزبانی ها</p></li>
                    <li><a href="<?php echo e(route('IndexHost')); ?>">اقامتگاه های ثبت شده</a></li>
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    ...
                    <li><a href="<?php echo e(route('IndexIntegrated')); ?>">مجتمع های ثبت شده</a></li>
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    ...
                    <li><a href="<?php echo e(route('IndexUserConfirm')); ?>">کاربران ویژه</a></li>
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    ...
                    <li><a href="<?php echo e(route('IndexReportCredit')); ?>">کیف پول</a></li>
                    <li><a href="<?php echo e(route('IndexAllCredit')); ?>">حساب های کل</a></li>
                    <li><a href="<?php echo e(route('IndexReportReserve')); ?>">رزروها</a></li>
                    <li><a href="<?php echo e(route('IndexReportChart')); ?>">نمودار</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    ...
                    <li><a href="<?php echo e(route('IndexSection')); ?>">مدیریت صفحه اصلی</a></li>
                    <li><a href="<?php echo e(route('IndexSlideShow')); ?>">مدیریت اسلاید شهرها</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sidebar-dropdown">
                    ...
                    <li><a href="<?php echo e(route('IndexCalendar')); ?>">مدیریت تقویم</a></li>
                </ul>
            </li>
