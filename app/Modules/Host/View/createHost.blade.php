...
@section('title', TitlePage('ثبت میزبانی جدید'))
@section('style')
...
@section('content')
    ...
    <div id="ExtraFormHost">
        @if($hostModel->step == 0)
            @include('Host::step.step1')
        @elseif($hostModel->step == 1)
            @include('Host::step.step2')
        @elseif($hostModel->step == 2)
            @include('Host::step.step3')
        @elseif($hostModel->step == 3)
            @include('Host::step.step4')
        @elseif($hostModel->step == 4)
            @include('Host::step.step5')
        @elseif($hostModel->step == 5)
            @include('Host::step.step6')
        @elseif($hostModel->step == 6)
            @include('Host::step.step7')
        @endif
    </div>
