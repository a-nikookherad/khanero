                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{$hostModel->name}}" name=""
                                               id="InputHostName"
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meter" value="{{$hostModel->meter}}" class="form-control"
                                           id="InputMeter"
                            ...
                            <div class="col-md-4 meter-total" style="display: none">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="meter_total" value="{{$hostModel->meter_total}}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="InputYear">
                                        @for($i = 1350; $i <= 1400; $i++)
                                            <option value="{{$i}}" @if($i == $hostModel->year) selected @endif>
                                                {{$i}}
                                            </option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="radio" value="1" name="reconstruction"
                                           @if($hostModel->reconstruction == 1) checked
                                           @endif id="InputReconstruction1"/>
                                    <label for="InputReconstruction1"> بله </label>
                                    <input type="radio" value="2" name="reconstruction"
                                           @if($hostModel->reconstruction == '' || $hostModel->reconstruction == 2) checked
                                           @endif id="InputReconstruction2"/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="InputBuildingFloors">
                                        @for($i = 1; $i <= 30; $i++)
                                            <option value="{{$i}}"
                                                    @if($i == $hostModel->building_floor) selected @endif>{{$i}}
                                            </option>
                                        @endfor
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="radio" value="1" name="type_rent"
                                           @if($hostModel->type_rent == 1) checked @elseif($hostModel->type_rent == null) checked @endif id="InputTypeRent1"/> <label
                                            for="InputTypeRent1"> مجزا </label>
                                    <input type="radio" value="2" name="type_rent"
                                           @if($hostModel->type_rent == 2) checked @endif id="InputTypeRent2"/> <label
                                            for="InputTypeRent2"> دربستی </label>
                                    <input type="radio" value="3" name="type_rent"
                                           @if($hostModel->type_rent == 3) checked @endif id="InputTypeRent3"/> <label
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="radio" value="1" name="register_by"
                                           @if($hostModel->register_by == 1) checked @endif id="InputRegisterBy1"/>
                                    <label
                                            for="InputRegisterBy1"> مالک </label>
                                    <input type="radio" value="2" name="register_by"
                                           @if($hostModel->register_by == 2) checked @endif id="InputRegisterBy2"/>
                                    <label
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="radio" value="1" name="shape_host"
                                           @if($hostModel->shape_host == 1) checked @elseif($hostModel->shape_host == null) checked @endif id="InputShapeHost1"/> <label
                                            for="InputShapeHost1"> مسطح </label>
                                    <input type="radio" value="2" name="shape_host"
                                           @if($hostModel->shape_host == 2) checked @endif id="InputShapeHost2"/> <label
                                            for="InputShapeHost2"> دوبلکس </label>
                                    <input type="radio" value="3" name="shape_host"
                                           @if($hostModel->shape_host == 3) checked @endif id="InputShapeHost3"/> <label
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="number">
                                        ...
                                        <input type="text" value="{{$hostModel->standard_guest}}" class="input-text"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="number">
                                        ...
                                        <input type="text" value="{{$hostModel->count_guest}}" class="input-text"
                        ...
                        <div class="row form-room">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="number">
                                    ...
                                    <input type="text" value="{{count($hostModel->getRoom)}}" class="input-text" id="InputCountRoom" readonly
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <select class="form-control" name="single_bed" id="InputSingleBed">
                                                        <option value="0" selected>ندارد</option>
                                                        @for($i = 1; $i <= 6; $i++)
                                                            <option value="{{$i}}" @if($value->single_beds == $i) selected @endif>{{$i}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <select class="form-control" name="double_bed" id="InputDoubleBed">
                                                        <option value="0" selected>ندارد</option>
                                                        @for($i = 1; $i <= 6; $i++)
                                                            <option value="{{$i}}" @if($value->double_beds == $i) selected @endif>{{$i}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <select class="form-control" name="sofa_bed" id="InputSofaBed">
                                                        <option value="0" selected>ندارد</option>
                                                        @for($i = 1; $i <= 6; $i++)
                                                            <option value="{{$i}}" @if($value->sofa_beds == $i) selected @endif>{{$i}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <select class="form-control" name="traditional_bedding"
                                                        ...
                                                        <option value="0" selected>ندارد</option>
                                                        @for($i = 1; $i <= 6; $i++)
                                                            <option value="{{$i}}" @if($value->traditional_beds == $i) selected @endif>{{$i}}</option>
                                                        @endfor
                                                    </select>
                                                </div>
                                            </div>
