                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="" id="InputMaxDaysForShowCalendar">
                                        ...
                                        <option value="180" @if($hostModel->max_day_show_calendar == 180) selected @endif>شش ماه</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" onkeyup="Seprator(this);" class="form-control" value="{{$hostModel->getPriceDay[0]->price / 1000}}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" onkeyup="Seprator(this);" class="form-control" value="{{$hostModel->getPriceDay[4]->price / 1000}}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" onkeyup="Seprator(this);" class="form-control" value="{{$hostModel->getPriceDay[5]->price / 1000}}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <input type="text" onkeyup="Seprator(this);" class="form-control" value="{{$hostModel->getPriceDay[6]->price / 1000}}"
                            ...
                            {{--                            <div class="col-md-12">--}}
                            {{--                                <div class="form-group">--}}
                            {{--                                    <label for="InputPriceSpecialDay">قیمت روزهای پیک و خاص</label>--}}
                            {{--                                    <input type="text" onkeyup="Seprator(this);" class="form-control"--}}
                            {{--                                           id="InputPriceSpecialDay" name=""--}}
                            {{--                                           placeholder="قیمت روزهای پیک و خاص"/>تومان--}}
                            {{--                                </div>--}}
                            {{--                             </div>--}}
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="InputOnePersonPrice">قیمت نفرات بیشتر از ظرفیت استاندارد</label>
                                    <input type="text" onkeyup="Seprator(this);" name="one_person_price" value="{{$hostModel->one_person_price / 1000}}"
                            ...
                            @if(count($hostModel->getDiscount) > 0)
                                @if(count($hostModel->getDiscount) == 1)
                                    @php
                            ...
                            @else
                                ...
                                @endphp
                            @endif
                            <div class="col-md-9 b-1 @if(count($hostModel->getDiscount) < 1) box-none-1 @endif">
                                <div class="form-group">
                                    بیشتر از
                                    <select id="InputDayDiscount" style="width: 200px; display: inline-block;" class="form-control" name="number_days">
                                        @for($i = 1; $i < 30; $i++)
                                            <option id="{{$i}}" @if($number_days_1 == $i) selected @endif>{{$i}}</option>
                                        @endfor
                                    </select>
                                    روز
                                    <input type="number" style="width: 60px;display: inline-block;" id="InputNumberPercent" value="{{ $percent_1 }}" name="percent" maxlength="2" class="text-center form-control" placeholder="00" />
                                    درصد تخفیف
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-9 b-2 @if(count($hostModel->getDiscount) < 2) box-none-2 @endif">
                                <div class="form-group">
                                    بیشتر از
                                    <select id="InputDayDiscount2" style="width: 200px; display: inline-block;" class="form-control" name="number_days_2">
                                        @for($i = 1; $i < 30; $i++)
                                            <option id="{{$i}}" @if($number_days_2 == $i) selected @endif>{{$i}}</option>
                                        @endfor
                                    </select>                                    روز
                                    <input type="number" style="width: 60px;display: inline-block;" id="InputNumberPercent2" value="{{ $percent_2 }}" name="percent_2" maxlength="2" class="text-center form-control" placeholder="00" />
                                    درصد تخفیف
                                </div>
                            </div>
