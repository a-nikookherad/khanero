...
<div class="Titl-step-S rows-address row">
    ...
    <div class="col-md-2 each-step register"><div class="Numbr-Step">5</div><span class="after-finish"><i class="far fa-check"></i></span><div class="poly"><a href="{{route('CreateHostStep', ['id' => $hostModel->id, 'step' => 4])}}">قوانین صاحبخانه</a></div></div>
...
{{--    <div class="each-item col-md-4">--}}
{{--                                    <label class="title-S" for="InputPriceSpecialDay">قیمت روزهای پیک و خاص</label>--}}
{{--                                    <input type="text" onkeyup="Seprator(this);" class="each-Qt form-control"--}}
...
{{--                             </div>--}}
        ...
        <div class="col-md-9 b-1 box-none-1">
                                <div class="form-group">
                                    ...
                                    روز
                                    <input type="number" style="width: 60px;display: inline-block;margin:0 3px;" id="InputNumberPercent" value="{{ old('percent') }}" name="percent" maxlength="2" class="each-Qt text-center form-control" placeholder="00" />
                                    درصد تخفیف
                                </div>
                            </div>
        <div class="col-md-3 each-option-1">
        ...
        <div class="col-md-9 b-2 box-none-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" style="width: 60px;display: inline-block;margin:0 3px;" id="InputNumberPercent2" value="{{ old('percent_2') }}" name="percent_2" maxlength="2" class="each-Qt text-center form-control" placeholder="00" />
                                    درصد تخفیف
                                </div>
                            </div>
        <div class="each-item col-md-12">
...
{{--                    </div>--}}
        <div class="col-md-12 row btn-footer">
                    <div class="col-xs-6 text-right">
                        <a href="{{route('CreateHostStep', ['id' => $hostModel->id, 'step' => 4])}}" class="prv-btn btn btn-default btn-block"> <i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i> مرحله قبلی </a>
                    </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.Success == 0) {
                        ...
                        window.location.replace('{{url(route('IndexHost', ['type' => 'all']))}}');
                    }
