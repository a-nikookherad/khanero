...
<div class="box-price">
    <div class="row">
        ...
        <div class="col-md-6 text-left">
            <span class="text-danger">{{count($array_price_date)}} شب</span>
        </div>
</div>
    @if($extraPriceForPerson != 0)
        <div class="row">
            <div class="col-md-6 text-right">
                نفرات اضافه
            </div>
            <div class="col-md-6 text-left">
                <span class="text-danger">{{number_format($extraPriceForPerson * count($array_price_date))}} تومان</span>
            </div>
        </div>
    @endif
    <hr />
