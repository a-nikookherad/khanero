...
//$upload_dir = '/Uploaded'; // path from base_url to upload base dir
//$current_path = $upload_dir; // relative path from filemanager folder to upload files folder


$base_url="http://rentt.ir";  // base url of site.

$upload_dir = '/Uploaded/Images'; // path from base_url to base of upload folder

$current_path = $upload_dir; // relative path from filemanager folder to upload folder
